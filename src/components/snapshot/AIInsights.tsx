  ...
  return [
    {
      ...
      body: `Brother, I want to say this with love: your marriage hit rock bottom at 3, and Sarah scored it at 2. She told you she feels lonely — and that took real courage from her.\n\nYou missed your anniversary for a client dinner. But you started date nights again and climbed back to 6. Sarah's score went from 2 to 5 — she sees the change. Don't stop now.\n\n> *"What God has joined together, let no one separate." — Mark 10:9*\n\nThe gap between your score (6) and hers (5) is the smallest it's been all year. Keep closing it.`,
    ...
    },
    {
      id: 'sales',
      emoji: '🙏',
      title: 'From 4 to 9 — but at what cost?',
      body: `Sales went from 4 to 9 in 12 months. The $1.2M deal, the overflowing pipeline, back-to-back records — God has clearly gifted you here, Jonathan.\n\nBut look at what else happened in those same 12 months: marriage crashed to 3, health dropped to 3, your doctor flagged your blood pressure. **Is this success costing you the things that matter most?**\n\nSuccess without presence is just a highlight reel. And you're building a life, not a highlight reel.`,
    },
    {
      id: 'intimacyWithJesus',
      emoji: '✝️',
      title: 'Your faith is reactive, not rooted.',
      body: `I notice a pattern: your walk with Jesus jumps to 7 when you attend a retreat or men's Bible study, then crashes to 3 when travel picks up. That oscillation — 5, 3, 4, 7, 5, 3, 4, 7, 5, 3, 5, 6 — tells me your spiritual life responds to *events* rather than daily discipline.\n\nThe retreat in June helped. The Bible study in November helped. What if you committed to something small but consistent — even 10 minutes in the Word before your first meeting?\n\n> *"Abide in me, and I in you. As the branch cannot bear fruit by itself, unless it abides in the vine." — John 15:4*\n\nYou don't need another mountaintop experience, brother. You need a daily rhythm.`,
